...
bool SocketClient::connectServer(const char* serverIP, unsigned short port)        //Á¬½Ó
{
	if (!this->initClient())
	{
		return false; 
...
void SocketClient::sendMessage(const char* data, int count)         //·¢ËÍ
{
	if (_socektClient != 0) 
	{
